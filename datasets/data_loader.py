...
from datasets.jigsaw_dataset import JigsawDataset, JigsawTestDataset
from datasets.rotate_dataset import RotateDataset, RotateTestDataset
...
def get_train_val_dataloader(args):
    ...
    if args.type == 'jigsaw':
        ...
        train_dataset = JigsawDataset(dataset_list, split='train', val_size=args.val_size,
        ...
        val_dataset = JigsawTestDataset(dataset_list, split='val', val_size=args.val_size,
        ...
        train_dataset = RotateDataset(dataset_list, split='train', val_size=args.val_size,
                                      img_transformer=img_transformer, rot_classes=args.aux_classes,
                                      bias_whole_image=args.bias_whole_image)
        val_dataset = RotateTestDataset(dataset_list, split='val', val_size=args.val_size,
...
def get_val_transformer(args):
    ...
    img_tr = img_tr = [transforms.Resize(tuple(size)), transforms.CenterCrop(224), transforms.ToTensor()]
    return transforms.Compose(img_tr)
