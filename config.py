...
if args.data.dataset.name == 'office':
    ...
    raise Exception('dataset {args.data.dataset.name} not supported!')
# print (args.data.dataset.source)
source_domain_name = args.datasets.src.name
target_domain_name = args.datasets.tar.name
# source_file = dataset.files[args.data.dataset.source]
# target_file = dataset.files[args.data.dataset.target]

# by yi new target data and test data
tar = args.datasets.tar
test = args.datasets.test
